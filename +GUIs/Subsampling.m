classdef Subsampling < GUIs.base
    ...
    methods
        function obj = Subsampling(fileName, examplesDirectory)
            ...
            obj.createInputImageSelectComboBoxAndText([0.06 0.96 0.25 0.03], [0.06 0.895 0.2 0.03]);
            ...
            for i=1:3
                ...
                obj.createTextElement([((0.33*(i-1))+0.01) 0.34 0.2 0.03], 'Subsampling Mode:', 10);
                obj.hSubsampleModeSelect{i} = uicontrol('Style', 'popupmenu', ...
                    'Parent', obj.hExternalPanel, ...
                    'FontSize', 10, ...
                    'FontName', 'Courier New',...
                    'Units', 'Normalized', ...
                    'Position',[((0.33*(i-1))+0.01) 0.31 0.14 0.03],...
                ...
                obj.hShowChannelUpsampledCheckBox{i} = uicontrol('Style', 'checkbox', ...
                    ...
                    'FontName', 'Courier New',...
                    'Units', 'Normalized', ...
                    'Position',[((0.33*(i-1))+0.2) 0.31 0.1 0.03],...
